...
@Component({
  ...
  template: `
  <div class="max-w-4xl mx-auto p-8 bg-gradient-to-r from-blue-50 to-indigo-100 shadow-xl rounded-xl">

    <!-- Department Form -->
    <div class="p-6 bg-white shadow-lg rounded-xl border border-indigo-300">
      <h2 class="text-3xl font-bold mb-5 text-indigo-800">🏢 Add New Department</h2>
    ...
    <!-- Department List -->
    <div class="p-6 bg-white shadow-lg rounded-xl mt-8 border border-indigo-300">
      <h2 class="text-3xl font-bold mb-5 text-indigo-800">📋 Department List</h2>
      <div class="flex flex-col gap-5">
        <div *ngFor="let d of departments" class="p-5 bg-indigo-50 border border-indigo-300 rounded-lg shadow-md">
          <div class="font-bold text-xl text-indigo-900">🏛️ {{ d.dept_name }}</div>
    ...
    <button (click)="navigateToHome()" 
      class="w-full mt-6 bg-blue-600 text-white font-semibold py-3 rounded-lg hover:bg-blue-700 transition">
      🔄 Go to Navigation
    </button>
